...
module.exports = async (req, res) => {
    ...
    if (req.method === 'POST') {
        ...
        try {
            ...
            // Ensure we always have a meaningful error message string.
            ...
            if (error instanceof Error) {
                ...
                try {
                    ...
                    errorMessage = 'Không thể chuyển đổi lỗi thành chuỗi.';
                }
            }
            res.status(500).json({ success: false, message: 'Lỗi tạo file PDF.', error: errorMessage });
        } finally {
            if (browser) {
                await browser.close();
            }
